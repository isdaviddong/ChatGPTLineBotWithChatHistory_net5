...
namespace isRock.Template
{
    ...
    {
        const string AzureOpenAIEndpoint = "https://_________________.openai.azure.com";  //👉replace it with your Azure OpenAI Endpoint
        const string AzureOpenAIModelName = "_________________"; //👉repleace it with your Azure OpenAI Model Name
        const string AzureOpenAIToken = "_________________"; //👉repleace it with your Azure OpenAI Token
