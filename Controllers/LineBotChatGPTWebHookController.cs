...
namespace isRock.Template
{
    public class LineBotChatGPTWebHookController : isRock.LineBot.LineWebHookControllerBase
    {
        ...
        {
            const string AdminUserId = "_________________"; //👉repleace it with your Admin User Id

            try
            {
                //設定ChannelAccessToken
                this.ChannelAccessToken = "__________________________________"; //👉repleace it with your Channel Access Token
                //配合Line Verify
